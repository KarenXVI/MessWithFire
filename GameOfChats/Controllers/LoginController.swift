...
class LoginController: UIViewController {
    ...
    lazy var loginRegisterButton: UIButton = {
        ...
        button.addTarget(self, action: #selector(hanldeLoginRegister), for: .touchUpInside)
        return button
    }()
    ...
    let nameSeparatorView: UIView = {
        let view = UIView()
        view.backgroundColor = UIColor(r: 28, g: 128, b: 156)
        view.translatesAutoresizingMaskIntoConstraints = false
        return view
    }()
    ...
    @objc func handleLoginRegisterChanged() {
        ...
        emailTextFiledHeightAnchor = emailTextField.heightAnchor.constraint(equalTo: inputsContainerView.heightAnchor, multiplier: loginRegisterSegmentedControl.selectedSegmentIndex == 0 ? 1/2 : 1/3)
        emailTextFiledHeightAnchor?.isActive = true
        
        passwordTextFiledHeightAnchor?.isActive = false
        passwordTextFiledHeightAnchor = passwordTextField.heightAnchor.constraint(equalTo: inputsContainerView.heightAnchor, multiplier: loginRegisterSegmentedControl.selectedSegmentIndex == 0 ? 1/2 : 1/3)
        passwordTextFiledHeightAnchor?.isActive = true
    }
    
    @objc func hanldeLoginRegister() {
    ...
    func handleLogin() {
        ...
        Auth.auth().signIn(withEmail: email, password: password) { (user, error) in
            if error != nil {
                print(error ?? "Error while sining in")
                return
            }
    ...
    func setupInputsContainerView() {
        ...
        emailTextFiledHeightAnchor = emailTextField.heightAnchor.constraint(equalTo: inputsContainerView.heightAnchor, multiplier: 1/3)
        emailTextFiledHeightAnchor?.isActive = true
